var mockPlants = [
    ...
    },
    {
        ...
        type: "leafy",
        description: "Kangkong, also known as swamp cabbage, is a leafy green vegetable that grows in water or moist soil. It is commonly used in Filipino dishes such as sinigang and adobo.",
    ...
    {
        name: "Talbos ng Kamote (Sweet Potato Leaves)",
        type: "leafy",
        description: "Talbos ng kamote, or sweet potato leaves, are the edible leaves of the sweet potato plant. They are a nutritious green vegetable commonly used in Filipino cuisine.",
        careTips: "Sweet potato leaves can be grown in both sunny and partially shaded areas. They require regular watering and well-drained soil. Harvest the leaves when they are young and tender."
    },
    {
        name: "Lettuce",
        type: "leafy",
...
function createVegetableCard(vegetable) {
    ...
    // You can provide image URLs or use placeholders
    vegetableImage.src = 'placeholder.jpg';
    ...
    // Toggle display of details when clicking on the card
